...
<html lang="en">
    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container">
                <div class="col-lg-4">
                <h1>Agregar Plato <i class="bi bi-pencil-square"></i></h1>
                <form action="PlatoServlet?action=insertar" method="POST">
                    <input class="form-control" type="text" name="platos" placeholder="Platos">
                    <br>
                    <input class="form-control" type="text" name="tipo" placeholder="Tipos">
                    <br>
            ...
            <a class="btn btn-success" type="submit" href="PlatoServlet?action=seleccionar">Ver registros</a>   
            </div>
            <!-- End Carousel-->
