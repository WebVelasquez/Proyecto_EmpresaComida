    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container">
                ...
                <form action="PlatoServlet?action=actualizar" method="POST">
                    <c:forEach items="${lista}" var="ver">
                        <label>Id</label>
                        <input class="form-control" type="text" name="id_plato" value="${ver.id_plato}">
                        <label>Plato</label>
                        <input class="form-control" type="text" name="platos" value="${ver.platos}">
                        <label>Tipo</label>
                        <input class="form-control" type="text" name="tipo" value="${ver.tipo}">
                        <label>Precio</label>
                        <input class="form-control" type="text" name="precio" value="${ver.precio}">                      
                    </c:forEach>
                    <button class="btn btn-primary" type="submit" >Actualizar <i class="bi bi-box-arrow-down"></i></button>
                    <br>
                    <button class="btn btn-primary" href="mostrarPlato.jsp" type="submit" >Cancelar <i class="bi bi-box-arrow-down"></i></button>
                </form>
                ${msg}
            </div>
            <a type="submit" href="PlatoServlet?action=seleccionar">Ver registros</a> 
            </div>
            <!-- End Carousel-->
