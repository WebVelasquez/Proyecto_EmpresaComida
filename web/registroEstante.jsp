...
<html lang="en">
    ...
    <body class="g-sidenav-show  bg-gray-200">
                ...
                <ul class="navbar-nav">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li><a class="dropdown-item" href="usuario?action=logout">Cerra Seccion</a></li>
                        </ul>
                    </div>
                </ul>                   
            </div>
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container">
                <div class="col-lg-4">
                    <h3>Agregar Estanteria <i class="bi bi-pencil-square"></i></h3>
                <form action="EstanteriaServlet?action=insertar" method="POST">
                    <input class="form-control" type="text" name="estante" placeholder="Estante">
                    <br>
                    <input class="form-control" type="text" name="tamanio" placeholder="Tamaño">
                    <br>
                    <label>Almacen</label>
                    <select type="id_almacen" name="id_almacen">
                            <c:forEach items="${listaAlmacenes}" var="e">
                                <option value="${e.getId_almacen()}">${e.getAlmacen()}</option>
                            </c:forEach>
                        </select>
                    <button class="btn btn-primary" type="submit" >Registrar <i class="bi bi-box-arrow-down"></i></button>
                </form>
                ${msg}
            </div>
            <a class="btn btn-success" type="submit" href="EstanteriaServlet?action=seleccionar">Ver registros</a>   
            </div>
            <!-- End Carousel-->
