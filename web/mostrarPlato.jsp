...
<html lang="en">
    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <!-- Carousel-->
            <div class="container">
                <h2>Mostrar Platos</h2>
            <br>
            <a class="btn btn-success" href="registroPlato.jsp"> Agregar Nuevo <i class="bi bi-person-plus-fill"></i></a>
            <br>
                ...
                <tbody>
                    <c:forEach items="${lista}" var="ver">
                        <tr>
                            ...
                            <td>${ver.precio}</td>
                            <td>
                                <a class="btn btn-warning" href="PlatoServlet?action=seleccionarById&id_plato=${ver.id_plato}"><i class="bi bi-pencil"></i></a>
                                <a class="btn btn-danger" href="PlatoServlet?action=eliminar&id_plato=${ver.id_plato}"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                    </c:forEach> 
                </tbody>
