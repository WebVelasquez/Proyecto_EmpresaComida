...
<html lang="en">
    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container">
                <div class="col-lg-4">
                    <h3>Agregar Pinches <i class="bi bi-pencil-square"></i></h3>
                <form action="PincheServlet?action=insertar" method="POST">
                    <input class="form-control" type="text" name="dni" placeholder="Dni">
                    <br>
                    <input class="form-control" type="text" name="nombre" placeholder="Nombres">
                    <br>
            ...
            <a class="btn btn-success" type="submit" href="PincheServlet?action=seleccionar">Ver registros</a>
            </div>
            <!-- End Carousel-->
