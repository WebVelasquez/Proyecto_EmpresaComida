...
<html lang="en">
    ...
    <body class="g-sidenav-show  bg-gray-200">
                ...
                <ul class="navbar-nav">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li><a class="dropdown-item" href="usuario?action=logout">Cerra Session</a></li>
                        </ul>
                    </div>
                </ul>
                    </div>
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container">
                <div class="col-lg-4">
                    <h3>Agregar Ingredientes <i class="bi bi-pencil-square"></i></h3>
                <form action="IngredienteServlet?action=insertar" method="POST">
                    <br>
                    <input class="form-control" type="text" name="ingrediente" placeholder="Ingredientes">
                    <br>
                    <input class="form-control" type="text" name="letra" placeholder="Letra">
                    <br>
            ...
            <a class="btn btn-success" type="submit" href="IngredienteServlet?action=seleccionar">Ver registros</a>           
            </div>
            <!-- End Carousel-->
