...
<html lang="en">
    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container">
                <div class="col-lg-4">
                <h3>Modificar Estantes</h3>
                <form action="EstanteriaServlet?action=actualizar" method="POST">
                    <c:forEach items="${lista}" var="ver">
                        <label>Id</label>
                        <input class="form-control" type="text" name="id_estanteria" value="${ver.id_estanteria}">
                        <label>Estante</label>
                        <input class="form-control" type="text" name="estante" value="${ver.estante}">
                        <label>Tamaño</label>
                        <input class="form-control" type="text" name="tamanio" value="${ver.tamaño}">                      
                        <label>Almacen</label>
                        <input class="form-control" type="text" name="id_almacen" value="${ver.id_almacen.id_almacen}">                      
                    </c:forEach>
                    <button class="btn btn-primary" type="submit" >Actualizar <i class="bi bi-box-arrow-down"></i></button>
                    <br>
                    <button class="btn btn-primary" href="mostrarEstanteria.jsp" type="submit" >Cancelar <i class="bi bi-box-arrow-down"></i></button>
                </form>
                ${msg}
            </div>
            <a type="submit" href="EstanteriaServlet?action=seleccionar">Ver registros</a> 
