    ...
    <body class="g-sidenav-show  bg-gray-200">
                ...
                <ul class="navbar-nav">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li><a class="dropdown-item" href="UsuarioServlet?action=logout">Cerra Session</a></li>
                        </ul>
                    </div>
                </ul>
                    </div>
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container">
                ...
                <form action="IngredienteServlet?action=actualizar" method="POST">
                    <c:forEach items="${lista}" var="ver">
                        <label>Id</label>
                        <input class="form-control" type="text" name="id_ingrediente" value="${ver.id_ingrediente}">
                        <label>Ingrediente</label>
                        <input class="form-control" type="text" name="ingrediente" value="${ver.ingrediente}">
                        <label>Letra</label>
                        <input class="form-control" type="text" name="letra" value="${ver.letra}">
                        <label>Cantidad</label>
                        <input class="form-control" type="text" name="cantidad" value="${ver.cantidad}">                      
                    </c:forEach>
                    <button class="btn btn-primary" type="submit" >Actualizar <i class="bi bi-box-arrow-down"></i></button>
                    <br>
                    <button class="btn btn-primary" href="mostrarIngredientes.jsp" type="submit" >Cancelar <i class="bi bi-box-arrow-down"></i></button>
                </form>
                ${msg}
            </div>
            <a type="submit" href="IngredienteServlet?action=seleccionar">Ver registros</a> 
            </div>
            <!-- End Carousel-->
