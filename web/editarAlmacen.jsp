    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container">
                ...
                <form action="AlmacenServlet?action=actualizar" method="POST">
                    <c:forEach items="${lista}" var="ver">
                        <label>Id</label>
                        <input class="form-control" type="text" name="id_almacen" value="${ver.id_almacen}">
                        <label>Almacen</label>
                        <input class="form-control" type="text" name="almacen" value="${ver.almacen}">
                        <label>Numero</label>
                        <input class="form-control" type="text" name="numero" value="${ver.numero}">
                        <label>Descripcion</label>
                        <input class="form-control" type="text" name="descripcion" value="${ver.descripcion}">                    
                    </c:forEach>
                    <button class="btn btn-primary" type="submit" >Actualizar <i class="bi bi-box-arrow-down"></i></button>
                    <br>
                    <button class="btn btn-primary" href="mostrarAlmacen.jsp" type="submit" >Cancelar <i class="bi bi-box-arrow-down"></i></button>
                </form>
                ${msg}
            </div>
            <a type="submit" href="AlmacenServlet?action=seleccionar">Ver registros</a> 
        </div>
            <!-- End Carousel-->
