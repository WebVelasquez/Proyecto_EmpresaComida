...
<html lang="en">
        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
            ...
            <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white active bg-gradient-primary" href="IngredientesServlet?action=seleccionar">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                            </div>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li><a class="dropdown-item" href="UsuarioServlet?action=logout">Cerra Seccion</a></li>
                        </ul>
                    </div>
                </ul>
            </div>
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container">
            <div class="col-lg-4">
                <h3>Modificar Cicineros</h3>
                <form action="CocineroServlet?action=actualizar" method="POST">
                    <c:forEach items="${lista}" var="ver">
                        <label>Id</label>
                        <input class="form-control" type="text" name="id_cocinero" value="${ver.id_cocinero}">
                        <label>Dni</label>
                        <input class="form-control" type="text" name="dni" value="${ver.dni}">
                        <label>Nombres</label>
                        <input class="form-control" type="text" name="nombres" value="${ver.nombres}">
                        <label>Apellidos</label>
                        <input class="form-control" type="text" name="apellidos" value="${ver.apellidos}">
                        <label>Telefono Fijo</label>
                        <input class="form-control" type="text" name="tel_fijo" value="${ver.tel_fijo}">
                        <label>Movil</label>
                        <input class="form-control" type="text" name="tel_movil" value="${ver.tel_movil}">                    
                        <label>Años laborales</label>
                        <input class="form-control" type="text" name="anios_servicio" value="${ver.anios_servicio}">                    
                    </c:forEach>
                    <button class="btn btn-primary" type="submit" >Actualizar <i class="bi bi-box-arrow-down"></i></button>
                    <br>
                    <button class="btn btn-primary" href="mostrarCocineros.jsp" type="submit" >Cancelar <i class="bi bi-box-arrow-down"></i></button>
                </form>
                ${msg}
            </div>
            <a type="submit" href="CocineroServlet?action=seleccionar">Ver registros</a> 
        </div>
        <!-- End Carousel-->
