...
<html lang="en">
    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container">
                <div class="col-lg-4">
                <h3>Modificar Pinches</h3>
                <form action="PincheServlet?action=actualizar" method="POST">
                    <c:forEach items="${lista}" var="ver">
                        <label>Id</label>
                        <input class="form-control" type="text" name="id_pinche" value="${ver.id_pinche}">
                        <label>Dni</label>
                    ...
                    <br>
                    <button class="btn btn-primary" href="mostrarPinches.jsp" type="submit" >Cancelar <i class="bi bi-box-arrow-down"></i></button>
                </form>
                ${msg}
            </div>
            <a type="submit" href="PincheServlet?action=seleccionar">Ver registros</a> 
            </div>
            <!-- End Carousel-->
