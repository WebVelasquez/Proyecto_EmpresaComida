...
<html lang="en">
    ...
    <body class="g-sidenav-show  bg-gray-200">
                ...
                <ul class="navbar-nav">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            ...
                            <li><a class="dropdown-item" href="usuario?action=logout">Cerrar Session</a></li>
                        </ul>
                    </div>
                </ul>
                    </div>
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container">
                <div class="col-lg-4">
                    <h3>Registrar Cocinero  <i class="bi bi-pencil-square"></i></h3>
                <form action="CocineroServlet?action=insertar" method="POST">
                    ...
                    <br>
                    <input class="form-control" type="text" name="tel_fijo" placeholder="Telefono">
                    <br>
                    <input class="form-control" type="text" name="tel_movil" placeholder="Movil">
                    <br>
                    <input class="form-control" type="text" name="anios_servicio" placeholder="Años laborales">
                    <br>
            ...
            <a class="btn btn-success" type="submit" href="CocineroServlet?action=seleccionar">Ver registros</a>
            </div>
            <!-- End Carousel-->
