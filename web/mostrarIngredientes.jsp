    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <div class="container">
                <h2>Ingredientes</h2>
            <br>
            <a class="btn btn-success" href="registroIngredientes.jsp"> Agregar Nuevo <i class="bi bi-person-plus-fill"></i></a>
            <br>
            <table class="table" style="text-align: center;">
                ...
                <tbody>
                    <c:forEach items="${lista}" var="ver">
                        <tr>
                            <td>${ver.id_ingrediente}</td>
                            <td>${ver.ingrediente}</td>
                            <td>${ver.letra}</td>
                            <td>${ver.cantidad}</td>
                            <td>
                                <a class="btn btn-warning" href="IngredienteServlet?action=seleccionarById&id_ingrediente=${ver.id_ingrediente}"><i class="bi bi-pencil"></i></a>
                                <a class="btn btn-danger" href="IngredienteServlet?action=eliminar&id_ingrediente=${ver.id_ingrediente}"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                    </c:forEach> 
                </tbody>
