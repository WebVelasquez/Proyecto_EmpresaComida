...
<html lang="en">
    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <!-- Carousel-->
            <div class="container">
                <h2>Mostrar Estantes</h2>
            <br>
            <a class="btn btn-success" href="EstanteriaServlet?action=irinsertar"> Agregar Nuevo <i class="bi bi-person-plus-fill"></i></a>
            <br>
            <table class="table" style="text-align: center;">
                ...
                <tbody>
                    <c:forEach items="${lista}" var="ver">
                        <tr>
                            <td>${ver.id_estanteria}</td>
                            <td>${ver.estante}</td>
                            <td>${ver.tamaño}</td>
                            <td>${ver.id_almacen.id_almacen}</td>
                            <td>
                                <a class="btn btn-warning" href="EstanteriaServlet?action=seleccionarById&id_estanteria=${ver.id_estanteria}"><i class="bi bi-pencil"></i></a>
                                <a class="btn btn-danger" href="EstanteriaServlet?action=eliminar&id_estanteria=${ver.id_estanteria}"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                    </c:forEach> 
                </tbody>
