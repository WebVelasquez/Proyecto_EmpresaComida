...
<html lang="en">
    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <!-- Carousel-->
            <div class="container">
               <h2>Mostrar los Almacenes</h2>
            <br>
            <a class="btn btn-success" href="registroAlmacen.jsp"> Agregar Nuevo <i class="bi bi-person-plus-fill"></i></a>
            <br>
            <table class="table" style="text-align: center;">
                ...
                <tbody>
                    <c:forEach items="${lista}" var="ver">
                        <tr>
                            <td>${ver.id_almacen}</td>
                            <td>${ver.almacen}</td>
                            <td>${ver.numero}</td>
                            <td>${ver.descripcion}</td>
                            <td>
                                <a class="btn btn-warning" href="AlmacenServlet?action=seleccionarById&id_almacen=${ver.id_almacen}"><i class="bi bi-pencil"></i></a>
                                <a class="btn btn-danger" href="AlmacenServlet?action=eliminar&id_almacen=${ver.id_almacen}"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                    </c:forEach> 
                </tbody>
