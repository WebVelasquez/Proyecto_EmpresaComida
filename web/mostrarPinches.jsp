...
<html lang="en">
    ...
    <body class="g-sidenav-show  bg-gray-200">
        ...
        <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
            ...
            <!-- Carousel-->
            <div class="container">
                <h2>Mostrar Pinches</h2>
            <br>
            <a class="btn btn-success" href="registroPinches.jsp"> Agregar Nuevo <i class="bi bi-person-plus-fill"></i></a>
            <br>
                ...
                <tbody>
                    <c:forEach items="${lista}" var="ver">
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-warning" href="PincheServlet?action=seleccionarById&id_pinche=${ver.id_pinche}"><i class="bi bi-pencil"></i></a>
                                <a class="btn btn-danger" href="PincheServlet?action=eliminar&id_pinche=${ver.id_pinche}"><i class="bi bi-trash"></i></a>
                            </td>
                        </tr>
                    </c:forEach> 
                </tbody>
